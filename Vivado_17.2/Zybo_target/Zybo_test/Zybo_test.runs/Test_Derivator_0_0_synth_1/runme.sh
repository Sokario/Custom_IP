...
HD_PWD='C:/Projet/Vivado/Custom_IP/Vivado_17.2/Zybo_target/Zybo_test/Zybo_test.runs/Test_Derivator_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Test_Derivator_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Test_Derivator_0_0.tcl
