...
HD_PWD='C:/Projet/Vivado/Custom_IP/Vivado_17.2/Zybo_target/Zybo_test/Zybo_test.runs/Test_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Test_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Test_auto_pc_0.tcl
