...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = Derivator
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = Derivator_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = pid
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = PID_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = Subtractor
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = Subtractor_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = Odometer
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = Odometer_0
END
