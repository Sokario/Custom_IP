...
proc update_PARAM_VALUE.EDGE_POLARITY { PARAM_VALUE.EDGE_POLARITY } {
	# Procedure called to update EDGE_POLARITY when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.EDGE_POLARITY { PARAM_VALUE.EDGE_POLARITY } {
	# Procedure called to validate EDGE_POLARITY
	return true
}
